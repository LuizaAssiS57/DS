...
// Menu de Embalagens. Crie um programa em Java que apresente um menu interativo sobre diferentes tipos de embalagens. O usuário poderá escolher entre três opções: caixa de papelão, sacola plástica e embalagem de vidro. O programa deve exibir uma breve descrição da embalagem escolhida. O menu deve se repetir até que o usuário selecione a opção de sair.
